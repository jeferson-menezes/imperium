    ...
    <q-page>
        <q-card>
            <q-item>
                ...
                <q-item-section>
                    <q-item-label class="text-h5">Histórico</q-item-label>
                </q-item-section>
            </q-item>

            <q-card-section ref="scrollTargetRef" style="max-height: 547px; overflow: auto;">
                <q-infinite-scroll :disable="scrollDisable" :initial-index="0" @load="onLoadRef" :offset="100"
